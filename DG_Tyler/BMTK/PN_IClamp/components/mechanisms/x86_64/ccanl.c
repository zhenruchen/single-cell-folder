...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 12, "cvodeieq");
 	...
 	ivoc_help("help ?1 ccanl /home/mizzou/Desktop/single-cell-folder/DG_Tyler/BMTK/PN_IClamp/components/mechanisms/x86_64/ccanl.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/single-cell-folder/DG_Tyler/BMTK/PN_IClamp/components/mechanisms/modfiles/ccanl.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
